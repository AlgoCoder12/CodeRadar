...
export default function ContestInfo() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden relative">
      {/* Background blobs */}
      <div className="absolute -inset-10 opacity-20 z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500 rounded-full blur-xl animate-pulse" />
        <div
          className="absolute top-3/4 right-1/4 w-96 h-96 bg-cyan-500 rounded-full blur-xl animate-pulse"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-pink-500 rounded-full blur-xl animate-pulse"
      ...
      <div className="relative z-10 px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-lg sm:text-xl leading-relaxed">
            Select your favorite coding platform and explore upcoming contests, challenges, and opportunities to sharpen your programming skills.
          </p>
        </div>

        {/* Platforms */}
        <div className="max-w-5xl mx-auto mb-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10 group-hover:border-white/20">
                    ...
                    <div className="relative mb-6">
                      <div className={`absolute inset-0 bg-gradient-to-r ${platform.bgGradient} rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-r ${platform.bgGradient} rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-500 pointer-events-none`} />
                  </div>
                </Link>
              </motion.div>
            )
